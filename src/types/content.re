...
let contentBlockFn = (theme) => {
  news: {
    title: (theme === Theme.AtariBlue || theme === Theme.AtariBlack) ? "5.News" : "News",
    content: [
      [
  ...
  team: {
    title: (theme === Theme.AtariBlue || theme === Theme.AtariBlack) ? "2.Team" : "Team",
    content: []
  },
  work: {
  ...
  services: {
    title: (theme === Theme.AtariBlue || theme === Theme.AtariBlack) ? "4.Services" : "Services",
    content: [
      [
        "Art Direction",
        "App Design",
  ...
  about: {
    title: (theme === Theme.AtariBlue || theme === Theme.AtariBlack) ? "1.About" : "About",
    content: [
  ...
  address: {
    title: (theme === Theme.AtariBlue || theme === Theme.AtariBlack) ? "6.Address" : "Address",
    content: [
      [
        "68 Jay Street",
        "Suite 201",
  ...
  follow: {
    title: (theme === Theme.AtariBlue || theme === Theme.AtariBlack) ? "7.Follow" : "Follow",
    content: [
      [
        "Medium",
        "Linkedin",
